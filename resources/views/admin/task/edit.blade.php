        ...
        <form action="{{ route('task.update', $task->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="text" class="form-control" id="given_date" name="given_date"
                        value="{{ $task->given_date }}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6 mt-3">
                    ...
                    <input type="date" class="form-control" id="started_at" name="started_at"
                        value="{{ $task->started_at }}" required min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}">
                </div>
